...
const Navbar = () => {
    ...
    const {user ,setUser,showUserLogin,setShowUserLogin,navigate
         ,setSearchQuery,searchQuery,getCartCount,getCartAmount} = useAppContext();
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                <NavLink to='/' className={({isActive})=>isActive ? "border-b-2 border-primary pb-1 text-primary" : "pb-1  transition"}>Home</NavLink>
                <NavLink to='/products' className={({isActive})=>isActive ? "border-b-2 border-primary pb-1 text-primary" : "pb-1  transition"}>All Product</NavLink>
                <NavLink to='/contact' className={({isActive})=>isActive ? "border-b-2 border-primary pb-1 text-primary" : "pb-1  transition"}>Contact</NavLink>
