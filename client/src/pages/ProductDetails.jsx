    ...
    return product && (
        <div className="mt-12">
            <p>
                ...
                <Link to={'/products'} className="hover:text-blue-600 hover:underline"> Products</Link> /
                <Link to={`/products/${product.category.toLowerCase()}`} className="hover:text-blue-600 hover:underline"> {product.category}</Link> /
